    ...
    <div className="dashboard-container">
      <header className={`main-header ${isScrolled ? 'scrolled' : ''}`}>
        ...
        <p className="header-subtitle" style={{ marginTop: '0.5rem', marginBottom: 0 }}>
          ...
          過去から学び、未来の体験を創り出す。
          <span style={{ fontSize: '0.75rem', color: '#94a3b8', marginLeft: '10px' }}>v1.0.69</span>
        </p>
      </header>
      ...
      <DashboardStats
        ...
        earmarkedMoney={earmarkedMoney}
        variableWishlistDeductions={variableWishlistDeductions}
        ...
        eventWishlistDeductions={eventWishlistDeductions}
        eventFundCovered={eventFundCovered}
        unrecoveredAdvances={unrecoveredAdvances}
        confirmRecoveryId={confirmRecoveryId}
        setConfirmRecoveryId={setConfirmRecoveryId}
        fetchData={fetchData}
        setShowReconcileModal={setShowReconcileModal}
      />
        ...
        <section className="glass-card" style={{ marginTop: '2rem' }}>
          ...
          <div style={{ overflowX: 'auto' }}>
            <table className="recent-table" style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
              ...
              <tbody>
                {recentTransactions.map((record: any) => {
